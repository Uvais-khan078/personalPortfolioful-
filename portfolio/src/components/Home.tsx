        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-24">
          <div className="flex flex-col md:flex-row items-center justify-center gap-12">
            <div className="md:w-1/3" data-aos="fade-right">
              <img src={`${apiBase}/images/${personal.image.split('/')[1]}`} alt="Profile" className="rounded-full w-64 h-64 object-cover mx-auto shadow-lg border-4 border-white" />
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/3 mb-10 md:mb-0" data-aos="fade-right">
              <img src={`/images/${personal.image.split('/')[1]}`} alt="Profile" className="rounded-full w-64 h-64 object-cover mx-auto shadow-lg" />
            </div>
